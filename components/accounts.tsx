  ...
  return (
    <div className="flex flex-col gap-2 flex-grow overflow-y-auto px-2 py-2">
      {accounts.map((account, index) => (
        <div key={index} className="rounded-lg shadow-md p-3 border-2 border-gray-100 flex items-center justify-between dark:border-zinc-800 dark:text-white dark:shadow-md shadow-sm">
